...
rarity_map = 1 (⚪️ Common), 2 (🟣 Rare) , 3 (🟡 Legendary), 4 (🟢 Medium),5 (💮 Special edition),6 (👶 Chibi)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟣 Rare", 3: "🟡 Legendary", 4: "🟢 Medium", 5: "💮 Special edition", 6: "👶 Chibi"}
        try:
...
async def update(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        if args[1] in ['name', 'anime']:
            ...
            rarity_map = {1: "⚪ Common", 2: "🟣 Rare", 3: "🟡 Legendary", 4: "🟢 Medium", 5: "💮 Special edition", 5: "👶 Chibi"}
            try:
